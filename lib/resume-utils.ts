...
export const mapExtractionToResumeData = (extraction: any, resumeName: string): ResumeData => {
    ...
    return {
        ...
        template: extraction.template, // Preserve template from extraction if available
        accentColor: extraction.accentColor // Preserve accent color
    };
}
