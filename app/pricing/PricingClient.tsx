    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-20 px-4 sm:px-6 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-20">
        ...
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          <Badge
            variant="secondary"
            className="px-4 py-1.5 text-sm font-medium text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/30 border-indigo-100 dark:border-indigo-900"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {PLANS.map((plan) => {
            ...
            const isDowngrade =
              user?.plan &&
              PLANS.findIndex((p) => p.key === user.plan) >
            ...
            return (
              ...
              >
                ...
                <CardHeader className="pb-8 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isCurrentPlan && (
                        <Badge
                          variant="outline"
                          className="text-indigo-600 border-indigo-200 bg-indigo-50 dark:bg-indigo-950/30 dark:border-indigo-800"
                        >
                          Current Plan
                        </Badge>
                      )}
                  ...
                  {/* CTA Button — right below price, styled per plan */}
                    ...
                    {isCurrentPlan && plan.key !== "FREE" && (
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button
                            variant="link"
                            className="w-full text-slate-400 hover:text-red-500 h-8 text-sm"
                            size="sm"
                ...
                {/* Feature list */}
                <CardContent className="space-y-4 border-t border-slate-100 dark:border-slate-800 pt-6">
                      ...
                      <li key={idx} className="flex items-start gap-3 text-sm">
                        ...
                        >
                          ...
                          {feature.text.includes("Resume AI credits") && (
                            <FeatureGuide
                              description="Credits used to generate highly optimized, tailored resumes for specific job descriptions."
                              className="ml-1.5 align-text-bottom inline-flex h-3.5 w-3.5"
                            />
                          )}
                          {feature.text.includes("Interview AI") && (
                            <FeatureGuide
                              description="AI mock interviews with a realistic 3D avatar and real-time feedback."
                              className="ml-1.5 align-text-bottom inline-flex h-3.5 w-3.5"
                            />
                          )}
                        </span>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        <FeatureGuide
                          description="Practice for your next role with our interactive AI avatar. Includes voice and video analysis."
                          className="h-4 w-4"
                        />
                      </div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">
                        Real-time AI voice &amp; video feedback
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        <FeatureGuide
                          description="Buy credits once and use them whenever you need to tailor a resume for a hot job lead."
                          className="h-4 w-4"
                        />
                      </div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">
