  ...
  return (
    <>
      ...
      <div className="flex overflow-hidden min-h-screen flex-col bg-white dark:bg-gray-900">
        ...
        <Hero/>
        <Features />
        <div id="features-container" className="relative max-[1000px]:top-[15svh] w-full overflow-hidden">
        <div className="svg-path max-[1000px]:hidden">
      <svg id="feature-svg" width="525" height="1238" viewBox="0 0 525 1238" fill="none" xmlns="http://www.w3.org/2000/svg">
